...
Flight Arc 專案記憶系統。Session 開頭讀這裡，結束時透過 `/wrap-up` 更新。
...
| [BACKLOG.md](BACKLOG.md) | 待辦清單（P0/P1/P2） | 新 idea / 完成項目 |
| [DATA_SCOPE.md](DATA_SCOPE.md) | 資料盤點矩陣 | 資料抓取完成後 |
...
| 規則 | `plan-art/CLAUDE.md` | 不變規則（程式風格、部署流程） |
| **狀態** | `plan-art/.claude/memory/` | **變動狀態 + 反省 + backlog** |
| 長文 | `plan-art/.claude/pitfalls/` | 事件的 long-form archive |
