...
- **不重複軌跡航班**：82,202 筆（`scripts/track-done.ndjson`）
- **機場 JSONL 檔**：2,299 座
...
- **進行中**：[Top-1000 全球網戰役](docs/backlog/data-fetching-status.md) — 2/18 全球前 1000 大機場軌跡，已 **52.7%**（8/20–21 三段共抓 16,000 筆／658K credits，**戰役過半**；Batch 1 的 39 座 megahub **100% 完成**，Batch 2 亞太 27 座清空）

| Region | 軌跡數（含雙向） | 大小 (gzip) |
|--------|------:|------:|
| other（未分區）| 37,701 | 12.11 MB |
| US 美國 | 26,055 | 7.51 MB |
