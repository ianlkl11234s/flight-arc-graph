...
- **不重複軌跡航班**：66,189 筆（`scripts/track-done.ndjson`）
- **機場 JSONL 檔**：1,845 座
...
- **進行中**：[Top-1000 全球網戰役](docs/backlog/data-fetching-status.md) — 2/18 全球前 1000 大機場軌跡，已 **28.6%**（8/09 兩輪共抓 11,545 筆／464K credits；Batch 1 剩 2,590。⚠️ 其餘亞洲 megahub 因字母序排在尾端幾乎沒抓到，下輪優先）

| Region | 軌跡數（含雙向） | 大小 (gzip) |
|--------|------:|------:|
| other（未分區）| 28,591 | 9.62 MB |
