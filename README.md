...
> **最後更新：2026-08-21** ｜ 數據來源：`public/tracks/manifest.json`（每次跑 `split-tracks.ts` 後更新）
> ⚠️ **抓完新軌跡後務必同步更新此表**（見下方維護說明）。

- **不重複軌跡航班**：82,501 筆（`scripts/track-done.ndjson`）
- **機場 JSONL 檔**：2,303 座
- **主動查詢機場**：290 座（165 core + 戰役 Batch 1 的 39 座 megahub **全滿** + Batch 2 的 86 座**部分完成**）
- **🌀 巴威颱風資料集**（2026-07-25 新增）：台灣 22 座機場 7/9–7/12 全時段起降軌跡 3,103 筆（7/11 桃機 760 架次全取消、出入境 0 人的「空白日」與前後疏散/回歸潮）
- **✅ ZUTF 成都天府 100% 完成**（2026-08-09）：戰役中**第一座從零推到全滿的亞洲 megahub**，2/18 全日 967 筆軌跡
- **✅ Batch 1 全滿**（2026-08-21）：全球運量前 39 大 megahub 在 2/18 的**所有起降軌跡 100% 到位**（dry-run 複驗待處理 0 筆）
- **✅ MMUN 坎昆 / OPKC 喀拉蚩 100% 完成**（2026-08-21，週期餘額 12,000 單點清空）：468 / 168 筆軌跡，零空零失敗
- **進行中**：[Top-1000 全球網戰役](docs/backlog/data-fetching-status.md) — 2/18 全球前 1000 大機場軌跡，已 **53.1%**（8/20–21 共抓 16,312 筆／~670K credits，**戰役過半**；Batch 1 的 39 座 megahub **100% 完成**，Batch 2 亞太 27 座清空）

| Region | 軌跡數（含雙向） | 大小 (gzip) |
|--------|------:|------:|
| other（未分區）| 38,000 | 12.19 MB |
| US 美國 | 26,091 | 7.52 MB |
| TW 台灣 | 12,230 | 3.78 MB |
| CN 中國 | 12,211 | 2.68 MB |
| JP 日本 | 5,624 | 1.67 MB |
| UK 英國 | 4,223 | 1.29 MB |
| KR 韓國 | 2,826 | 0.83 MB |
| TH 泰國 | 2,694 | 0.87 MB |
...
| 機場 | 軌跡 | 機場 | 軌跡 | 機場 | 軌跡 |
|------|---:|------|---:|------|---:|
| ★RCTP 桃園 | 7,693 | ★VHHH 香港 | 1,878 | ★RCSS 松山 | 1,527 |
| ★OMDB 杜拜 | 2,968 | ★KLAX 洛杉磯 | 1,844 | ★KDFW 達拉斯 | 1,521 |
| ★WSSS 新加坡 | 2,050 | ★RCKH 高雄 | 1,806 | ★KSFO 舊金山 | 1,518 |
| ★KORD 芝加哥 | 2,009 | ★ZSPD 浦東 | 1,735 | ★KDEN 丹佛 | 1,505 |
| ★KATL 亞特蘭大 | 1,886 | ★ZGGG 廣州 | 1,559 | ★RKSI 仁川 | 1,505 |
